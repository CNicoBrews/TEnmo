...
private static final String API_BASE_URL = "http://localhost:8080/";
	...
	private void viewCurrentBalance() {
		BigDecimal balance = accountsService.getBalance(currentUser);
		if (balance != null) {
	...
	private void viewTransferHistory() {
		Transfers transfers = accountsService.transferHistory(currentUser.getUser().getId());
		System.out.println("Your transfer history is =" + transfers);
	}
	...
	private void sendBucks() {
		User[] users = authenticationService.listUsers();
		if (users != null) {
			...
			String user = console.getUserInput("Please select a user to send money to");
